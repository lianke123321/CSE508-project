...
int main(int argc, char *argv[]) {
	...
	if (regexp == NULL) {
		printf("Please specify the match pattern of the packets which you want to spoof response!\n");
		return 0;
	}
	
	if (datafile == NULL) {
		printf("Please specify the data file you want to use as the spoofed payload!\n");
		return 0;
	}
